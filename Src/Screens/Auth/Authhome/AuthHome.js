...
export default function AuthHome() {
  ...
  const headerText = [
    '<h1>One Click Away From Your Destination 🚀</h1>',
    '<h1>Enjoy Your Stay With Desh..</h1>',
    '<h1>Hope You Have Grate Time With US...</h1>',
    '<h1>Give Me Your Detail FAST</h1>',
  ];
    ...
    <Animated.View style={styles.container}>
      <Animated.View style={styles.topView}>
        <Animated.View style={styles.contain}>
          <Animated.Image style={styles.headerImage} source={Images.AuthHome} />
